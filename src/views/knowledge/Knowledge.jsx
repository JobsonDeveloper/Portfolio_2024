        ...
        <ul className="jd_sections">
          ...
          <li className="jd_sections_itens jd_certificates">
            ...
            <article className="jd_main_certificates" data-aos="fade-left">
              {certificatePage === 1 && (
                <CertificatesCard
                  certificateUrl={AWSCloudPratitioner}
                  showCertificate={showCertificate}
                  driveLink="https://drive.google.com/file/d/1AhVPLNHKLizF3jdDr6Qwdh31FrTOw7dA/view?usp=drive_link"
                />
              )}
              {certificatePage === 2 && (
                <CertificatesCard
              ...
              {certificatePage === 11 && (
                <CertificatesCard
                  ...
                  showCertificate={showCertificate}
                  driveLink="https://drive.google.com/file/d/1GF6GIaBftSmWxOx9VKm6RwQVSNPnOLz8/view?usp=drive_link"
                />
              )}
          ...
          <li className="jd_sections_itens jd_hard_skills">
            <article
              className="jd_sections_titles jd_title_right"
              data-aos="fade-left"
            >
            ...
            <article
              className="jd_hard_skills_container jd_front_end"
              data-aos="fade-right"
            >
            ...
            <article
              className="jd_hard_skills_container jd_back_end"
              data-aos="fade-right"
            >
              <article className="jd_hard_skills_substitles">
            ...
            <article
              className="jd_hard_skills_container jd_oder_skills"
              data-aos="fade-right"
            >
              <article className="jd_hard_skills_substitles">
                <h6 className="jd_hardk_skills_subtitles_title">
                  Outras Tecnologias
                </h6>
              </article>
              ...
              <ul className="jd_hard_skills_container_list">
                ...
                <Tilt options={defaultOptions}>
                  <li className="jd_hard_skills_item" title="Cloud Computing">
                    <TbCloudComputing className="jd_hard_skills_item_icon" />
                  </li>
                </Tilt>
                <Tilt options={defaultOptions}>
                  <li className="jd_hard_skills_item" title="AWS">
                    <FaAws className="jd_hard_skills_item_icon" />
                  </li>
                </Tilt>
              </ul>
            </article>
